...
trainer = pl.Trainer(max_epochs=10, logger=logger, accumulate_grad_batches=50, precision=32, log_every_n_steps=5)
backbone.eval()
...
trainer = pl.Trainer(max_epochs=10, logger=logger, accumulate_grad_batches=1, precision=32, log_every_n_steps=5)
